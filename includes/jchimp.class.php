...
require_once dirname(__FILE__) . '/jchimp.classes/Folders.php';
require_once dirname(__FILE__) . '/jchimp.classes/Templates.php';
require_once dirname(__FILE__) . '/jchimp.classes/Users.php';
require_once dirname(__FILE__) . '/jchimp.classes/Helper.php';
require_once dirname(__FILE__) . '/jchimp.classes/Mobile.php';
require_once dirname(__FILE__) . '/jchimp.classes/Ecomm.php';
require_once dirname(__FILE__) . '/jchimp.classes/Neapolitan.php';
require_once dirname(__FILE__) . '/jchimp.classes/Lists.php';
require_once dirname(__FILE__) . '/jchimp.classes/Campaigns.php';
require_once dirname(__FILE__) . '/jchimp.classes/Vip.php';
require_once dirname(__FILE__) . '/jchimp.classes/Reports.php';
require_once dirname(__FILE__) . '/jchimp.classes/Gallery.php';
require_once dirname(__FILE__) . '/jchimp.classes/Exceptions.php';
